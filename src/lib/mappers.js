...
export function applicationFromDb(row) {
  return {
    ...
    message: row.message,
    proposedPrice: row.proposed_price,
    proposedPriceGrouped: row.proposed_price_grouped,
    pickupEarliestAt: row.pickup_earliest_at,
    pickupLatestAt: row.pickup_latest_at,
    deliveryEarliestAt: row.delivery_earliest_at,
    deliveryLatestAt: row.delivery_latest_at,
